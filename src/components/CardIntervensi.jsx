    ...
    <>
      <div className="bg-primary h-auto px-6 pt-8 pb-20 rounded-xl">
        <div className=" flex justify-between items-center">
          ...
          <button className=" border rounded-md bg-shadow hover:bg-white text-darkSmooth text-sm border-gray-500  flex gap-2 items-center p-2">
        ...
        <div className="mt-8 ">
          <div className="flex items-center gap-2 bg-greenSmooth w-1/2 p-2   text-light">
            ...
            <h2 className="text-md font-semibold"> Kesehatan Ibu dan Anak</h2>
          </div>
          <div className="flex flex-col gap-2 mt-6 ml-4 text-light font-medium text-sm">
        ...
        <div className="mt-8 ">
          ...
          <div className="flex flex-col gap-2 mt-6 ml-4 text-light text-sm font-medium">
            {intervensiModel.map((item, idx) => (
              <div key={item.id} className="flex gap-2 ">
                <span>{idx + 1}.</span>
                <span>{item.caption}</span>
