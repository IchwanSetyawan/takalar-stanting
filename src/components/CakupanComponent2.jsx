          ...
          {firstHalf.map((item, id) => (
            <>
              <div className="mt-4 relative z-10" key={id}>
                <div>
                  <div className=" text flex justify-between items-start mb-1 gap-2">
                  ...
                  <div className="bar ml-7 mt-2 flex justify-between items-center">
...
export default CakupanComponent2;
